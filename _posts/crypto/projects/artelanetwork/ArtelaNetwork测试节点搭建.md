...
+ 设置持久化节点
     ...
     sed -i 's/seeds = ""/seeds = "9e2fbfc4b32a1b013e53f3fc9b45638f4cddee36@47.254.66.177:26656,30fb0055aced21472a01911353101bc4cd356bb3@47.89.230.117:26656"/' config.toml
     ```
+ 设置状态同步
     ...
     sed -i 's/trust_height = 0/trust_height = 3966991/' config.toml
     sed -i 's/trust_hash = ""/trust_hash = "61b07f1fac56f15e96826913c9d950080384e79a9c57007ba9d8eab18d6b6e6f"/' config.toml

     # e.g sed -i 's/rpc_servers = ""/rpc_servers = "172.16.10.2:26657,172.16.10.4:26657"/' config.toml
     sed -i 's/rpc_servers = ""/rpc_servers = "47.254.66.177:26657,47.89.230.117:26657"/' config.toml
     ```
+ 设置 app.toml
