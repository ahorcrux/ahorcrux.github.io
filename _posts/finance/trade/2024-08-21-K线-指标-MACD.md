...
plot(signal_C, color=color.red, title="SIGNAL (Crossover)")
plot(macd_C, color=color.blue, title="MACD (Crossover)")
...
plot(currMacd_4C, style=plot.style_histogram, color=plotColor_4C, linewidth=3, title="MACD 4C")
